# Review dump — stats diff backend

## `ollin-backend/src/routes/partido.js` (completo)

Ruta montada como `GET /api/ollin/fixtures/partido/:id`.
...
## `ollin-backend/src/services/footballPolling.js` (completo)
