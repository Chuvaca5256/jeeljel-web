...
const APPS = [
  {
    ...
    badge: 'LIVE',
    badgeColor: '#1db8a0',
    desc: 'Inteligencia artificial que te escucha, mira, lee y sabe lo que sientes.',
    link: 'https://ikannaat.jeeljel.com',
    linkActivo: true,
    logo: logoIkanNaat,
  },
  {
    nombre: 'Ollin Deportes',
    acento: '#e85d26',
    badge: 'URGENTE',
    badgeColor: '#e85d26',
  ...
  },
  {
    ...
    badge: 'FASE 1',
    badgeColor: '#7b2d8b',
    desc: 'No solo es una tarjeta virtual, también es un organizador y ayuda para el día a día.',
    logo: logoVirtyou,
  },
  {
    nombre: 'Izydra OS',
    ...
    badge: 'QA',
    badgeColor: '#c9a84c',
    desc: 'Organiza, crea y olvídate del trabajo pesado.',
    logo: logoIzydra,
  },
  {
    nombre: 'Inkógnito',
    ...
    badge: '+18',
    badgeColor: '#8b2a2a',
    desc: 'La red social para lo que nadie se atreve, pero en modo Inkógnito sin censura.',
